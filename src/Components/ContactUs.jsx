  ...
  return (
    <>
      <div className=" w-[1300px] h-[800px] rounded-[20px] bg-[#45776B] relative">
        {/* contact us info */}
        <div className="info inline-flex flex-col w-[343px] h-[480px] items-start gap-[45px] mt-[116px] ml-[86px] mr-[871px] mb-[204px] absolute">
          {/* 1 */}
          ...
          {/* 3 */}
          <div
            className="info flex w-[331px] px-[19px] py-[13px] flex-col items-start gap-[10px] rounded-[10px] border-[1px] border-solid
          border-[#FFF]"
          >
